<template>
  <div>
    ...
    <div class="modal fade" id="createKlasifikasiMasalah" ref="klasifikasiMasalahModal" tabindex="-1" aria-labelledby="createKlasifikasiMasalahLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
    ...
    changeLabels(type, to) {
      if (type == 'create') {
        ...
        if (to == 'divisi') {
          ...
          document.getElementById('createKlasifikasiMasalahLabel').innerHTML = 'Create Klasifikasi'
